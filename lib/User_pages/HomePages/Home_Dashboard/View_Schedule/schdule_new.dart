...
class ScheduleHistory1 extends StatefulWidget {
  final int userId;

  const ScheduleHistory1({Key? key, required this.userId}) : super(key: key);

  @override
  State<ScheduleHistory1> createState() => _ScheduleHistoryState();
}

class _ScheduleHistoryState extends State<ScheduleHistory1> {
  ...
  void initState() {
    ...
    futurescheduleHistory = Provider.of<UserProvider>(context, listen: false)
        .getTourSchedulesHistory(widget.userId);
  }

  @override
  void didUpdateWidget(covariant ScheduleHistory1 oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'Schedule Lists'),
